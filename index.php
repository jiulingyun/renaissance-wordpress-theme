...
if ($is_elementor) {
    ...
    // 非 Elementor 页面，显示提示信息
    ?>
    <main style="min-height: 80vh; display: flex; align-items: center; justify-content: center;">
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <h1 style="color: #fff; margin-bottom: 1rem;">Welcome to Renaissance</h1>
                    <p style="color: rgba(255,255,255,0.7); margin-bottom: 2rem;">
                        Please use Elementor to design your homepage, or the admin can set a static page as the homepage.
                    </p>
